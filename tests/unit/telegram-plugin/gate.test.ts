/**
 * Unit tests for gate() logic using gateLogic() from plugins/telegram/pure.ts
 */
import { gateLogic, defaultAccess, pruneExpired, Access, GateInput } from '../../../plugins/telegram/pure'
